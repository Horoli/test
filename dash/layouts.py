...
LOGO = "https://image.rocketpunch.com/company/80255/brgg_logo_1565673135.png?s=400x400&t=inside"
...
sidebar = html.Div([
    ...
    html.Hr(),
    html.P('Cloudfunding(Wadiz) data look up system', className='lead'),
    dbc.Nav([
        dbc.NavLink('Home', href='/', active='exact'),
        dbc.NavLink('카테고리별 데이터 조회', href='/page-1', active='exact'),
    ...
    dbc.Navbar([
       html.A(
           dbc.Row([
               ...
               dbc.Col(dbc.NavbarBrand('OOOA', className='ml-2')),
